...
import Citas from './componentes/PagesAdmin/CitasAdmin';
...
function Main() {
    ...
    return (
        <>
            ...
            <Modalinicio />
            <ModalRegistro />
            <ToastContainer position="top-right" autoClose={3000} hideProgressBar={false} draggable pauseOnHover />
        </>
    );
}
...
function App() {
    ...
    useEffect(() => {
        ...
        const rol = sessionStorage.getItem('rol') || 'cliente';
