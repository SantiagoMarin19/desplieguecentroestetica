...
import qr from '../../assets/images/qr.png'; // Asegúrate de que la ruta sea correcta
import bancolombia from '../../assets/images/bancolombia.png'; // Asegúrate de que la ruta sea correcta
