...
export default function Nosotros() {
    return (
        <div>
            ...
            <p>
                Con más de 4 años de experiencia, Natalia Salazar Artist ha logrado la satisfacción de más de mil clientas,
            ...
            <p>
                ...
                Micropigmentación: Perfeccionamos la forma de las cejas, labios y ojos, utilizando técnicas precisas para garantizar un resultado natural y armónico.

                Lifting y Extensiones de Pestañas: Realzamos la belleza de tus ojos con tratamientos que añaden volumen y longitud a tus pestañas, brindándote una mirada irresistible.

                Cuidado de Cejas: Desde el diseño hasta la tintura, nuestras técnicas aseguran cejas perfectamente definidas que complementan tu rostro.</p>
            ...
            <p>
                ...
                productos de primera línea y técnicas innovadoras para garantizar resultados que superen las expectativas. En Natalia Salazar Artist, tu belleza es nuestra pasión.</p>

            <h2> Ubicacion y contacto  </h2>
            <p> La satisfacción de nuestras clientas es nuestra máxima prioridad. Nos esforzamos por ofrecer un servicio personalizado y de calidad, 
                utilizando productos de primera línea y técnicas innovadoras para garantizar resultados que superen las expectativas. En Natalia Salazar Artist, tu belleza es nuestra pasión.</p>
